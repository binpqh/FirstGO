...
func newStudent(db *gorm.DB, opts ...gen.DOOption) student {
	...
	_student.StudentID = field.NewInt64(tableName, "StudentId")
	_student.Name = field.NewString(tableName, "Name")
	_student.Birthday = field.NewTime(tableName, "Birthday")
	_student.ClassID = field.NewInt64(tableName, "ClassId")
	_student.UserID = field.NewInt64(tableName, "UserId")
...
func (s *student) updateTableName(table string) *student {
	...
	s.StudentID = field.NewInt64(table, "StudentId")
	s.Name = field.NewString(table, "Name")
	s.Birthday = field.NewTime(table, "Birthday")
	s.ClassID = field.NewInt64(table, "ClassId")
...
func (s *student) fillFieldMap() {
	...
	s.fieldMap["StudentId"] = s.StudentID
	s.fieldMap["Name"] = s.Name
	s.fieldMap["Birthday"] = s.Birthday
	s.fieldMap["ClassId"] = s.ClassID
