...
func newTeacher(db *gorm.DB, opts ...gen.DOOption) teacher {
	...
	_teacher.TeacherID = field.NewInt64(tableName, "TeacherId")
	_teacher.Name = field.NewString(tableName, "Name")
	_teacher.Birthday = field.NewTime(tableName, "Birthday")
	_teacher.UserID = field.NewInt64(tableName, "UserId")
...
func (t *teacher) updateTableName(table string) *teacher {
	...
	t.TeacherID = field.NewInt64(table, "TeacherId")
...
func (t *teacher) fillFieldMap() {
	...
	t.fieldMap["TeacherId"] = t.TeacherID
